...
%% @end
%%------------------------------------------------------------------------------
-spec past_available_units(kz_term:ne_binary()) -> kz_currency:available_units_return().
...
%% @end
%%------------------------------------------------------------------------------
-spec past_available_dollars(kz_term:ne_binary()) -> kz_currency:available_dollars_return().
...
-spec past_available_dollars(kz_term:ne_binary(), kz_time:year(), kz_time:month()) ->
                                  kz_currency:available_dollars_return().
